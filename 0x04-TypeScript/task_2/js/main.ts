interface DirectorsInterface {
  ...
  console.log(createEmployee('Maina', 'Jenga', 200));
  console.log(createEmployee('Owiti', 'Owino', 1000));
  console.log(createEmployee('Halima', 'Bakari', '$500'));
  ...
  console.log(executeWork(createEmployee('Maina', 'Jenga', 200)));
  console.log(executeWork(createEmployee('Owiti', 'Owino', 1000)));
